...
export const Basket = () => {
    const totalPrice = useSelector(({busket})=> busket.totalPrice)
    const totalCount = useSelector(({busket})=> busket.itemsCount)
    return (
        <div>
          ...
          <div className="cart">
            <div className="cart__top">
              ...
              <div className="cart__clear">
               ...
               <Link to='/empty-basket'> <span>Очистить корзину</span></Link>
              </div>
            </div>
            ...
            <div className="cart__item-img">
                ...
                src="https://images.ua.prom.st/842371888_w640_h640_myagkaya-igrushka-zhdun.jpg"
                alt="toys"
                />
            </div>
            ...
            <div className="cart__bottom">
              <div className="cart__bottom-details">
                <span> Всего игрушек: <b>{totalCount} шт.</b> </span>
